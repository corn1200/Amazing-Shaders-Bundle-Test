...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    internal class BeastLitShader : BaseShaderGUI
    {
        ...
        private BeastLitDetailGUI.LitProperties litDetailProperties;
        ...
        {
            materialScopesList.RegisterHeaderScope(BeastLitDetailGUI.Styles.detailInputs, Expandable.Details, _ => BeastLitDetailGUI.DoDetailArea(litDetailProperties, materialEditor));
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            litDetailProperties = new BeastLitDetailGUI.LitProperties(properties);
        ...
        {
            SetMaterialKeywords(material, LitGUI.SetMaterialKeywords, BeastLitDetailGUI.SetMaterialKeywords);
