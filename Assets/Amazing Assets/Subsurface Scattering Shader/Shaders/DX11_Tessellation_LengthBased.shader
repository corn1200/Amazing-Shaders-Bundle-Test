Shader "Amazing Assets/Subsurface Scattering/Tessellation (SM 5.0)/Length Based"
{
	Properties 
	{
//[HideInInspector][CurvedWorldBendSettings] _CurvedWorldBendSettings("0|1|1", Vector) = (0, 0, 0, 0)
		...
		//Tessellation
		[Space(20)] _SSS_Tessellation_EdgeLength ("Edge length", Range(2, 50)) = 15
		_SSS_DisplacementStrength ("Displacement", Range(0, 1.0)) = 0.3
...
//#include "Assets/Amazing Assets/Curved World/Shaders/Core/CurvedWorldTransform.cginc"
			...
			#define _SSS_TESSELLATION_LENGTH_BASED
